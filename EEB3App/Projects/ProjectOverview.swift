...
class ProjectOverview: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        handle = ref?.child("project").child(mySelectedProject).child("Overview").observe(.childAdded, with: { (snapshot) in
