...
class ProjectParticipate: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        handle = ref?.child("project").child(mySelectedProject).child("Participate").observe(.childAdded, with: { (snapshot) in
